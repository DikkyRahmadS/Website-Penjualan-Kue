...
<div class="box_menu_admin" id="box_menu_admin">
    <div class="menu_admin">
        ...
        <div class="menu_list">
            ...
            <a href="<?php echo $url; ?>admin/rugilaba">
                <div class="<?php if ($page_admin == 'rugi laba') {
                                echo 'menu_list_isi_active';
                            } else {
                                echo 'menu_list_isi';
                            } ?>">
            ...
            <a href="<?php echo $url; ?>admin/laporanbulanan">
                <div class="<?php if ($page_admin == 'laporan bulanan') {
                                echo 'menu_list_isi_active';
                            } else {
                                echo 'menu_list_isi';
                            } ?>">
