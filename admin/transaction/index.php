...
<body>
    ...
    <div class="back_up_ri" id="back_up_ri">
        <div class="up_ri">
            <h1>Masukkan Pilihan Ambil Ke Toko Atau Gojek</h1>
            <input type="hidden" id="idinvoice_pss">
            <!-- <input type="text" class="input" id="resi_pengiriman_v" placeholder="Ambil Ke Toko atau Gojek"> -->
            <select name="resi_pengiriman_v" id="resi_pengiriman_v" class="input">
                <option value="1">Ambil Ke Toko</option>
