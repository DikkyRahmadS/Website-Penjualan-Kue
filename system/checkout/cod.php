...
$update_bt = $server->query("UPDATE `invoice` SET `bank_manual`='$nama_bank_bt',`tipe_progress`='Dikemas',`bukti_transfer`='$name1',`waktu_transaksi`='$time' WHERE `idinvoice`='$id_inv_bt' ");
