...
switch($resi_pengiriman_v) {
    case 1:
        $pilihanTerakhir  = "Ambil Ke Toko";
        break;
    case 2:
        $pilihanTerakhir  = "Gojek";
        break;
}
...
$update_dikirim = $server->query("UPDATE `invoice` SET `resi`='$pilihanTerakhir', `tipe_progress`='Dikirim', `waktu_dikirim`='$time' WHERE `idinvoice`='$idinvoicesb' ");
