...
function upload_bukti_transfer_manual(id_inv_bt, nama_bank_bt) {
    if (inp_bukti_transfer.value == '') {
        ...
        xhttp.open("POST", "../../system/checkout/cod.php", true);
...
var buktiTransfer = document.getElementById('buktiTransfer');
var ubt = document.getElementById('ubt');
...
function pilihan(){
var pilihanPembayaran = document.getElementById('pilihanPembayaran').value;
var inp_bukti_transfer = document.getElementById('inp_bukti_transfer');
var bank = document.getElementById('Bank');
var nomorRekening = document.getElementById('nomorRekening');
var ubt = document.getElementById('ubt');
    ...
    // console.log(pilihanPembayaran)
}
back_transfer_manual.style.display ='none';