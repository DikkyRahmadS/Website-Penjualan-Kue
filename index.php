    ...
    <div class="width">
        ...
        <div class="banner_iklan">
            <div class="banner_big_iklan">
                <div class="owl-carousel owl-theme">
                        <img src="./assets/image/banner/317873c8a7e1cfc9abca57b7927cfb50.png" class="img_banner_big_iklan">
                        <img src="./assets/image/banner/29aec5f97bc7ddc3974138904a617dd6.png" class="img_banner_big_iklan">
                        <img src="./assets/image/banner/a78b4c8f71e949c3d7a1c414e6dc7366.png" class="img_banner_big_iklan">
                </div>
            </div>
        </div>
        <!-- KATEGORI -->
        ...
        <div class="flash_sale">
            ...
            <div class="box_iklan_flash_sale grid_terlaris">
                <?php
                $produk_terlaris = $server->query("SELECT * FROM `iklan` WHERE `tipe_iklan`='' ORDER BY `id` DESC LIMIT 100");
