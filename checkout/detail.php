    ...
    <div class="back_transfer_manual" id="back_transfer_manual">
        <div class="transfer_manual">
            ...
            <div class="box_transfer_manual">
                <div class="isi_box_transfer_manual" id="Bank">
                    <h5>BANK <?php echo $data_norek['nama_bank']; ?></h5>
                    <h6>a.n <?php echo $data_norek['an']; ?></h6>
                </div>
                <div class="isi_box_transfer_manual" id="nomorRekening">
                ...
                <select name="pilihanPembayaran" id="pilihanPembayaran" class="input" onclick="pilihan()">
                        <option value="1">--Pilih Pembayaran--</option>
                        <option value="2">Transfer</option>
                        <option value="3">COD</option>
                </select>
                </div>
                <div class="isi_box_transfer_manual" id="buktiTransfer">
                ...
                <div class="isi_box_transfer_manual">
                    <div class="button" id="ubt" onclick="upload_bukti_transfer_manual('<?php echo $id_invoice; ?>', '<?php echo $data_norek['nama_bank']; ?>')">
                        <p class="button">Upload Bukti Transfer</p>
                    </div>
                    ...
                    <!-- <div class="opsi_pengiriman">
                        ...
                        <div class="box_isi_opsi_pengiriman">
                            <div class="isi_opsi_pengiriman">
                                <h4 id="ubah_onkirrrr" onclick="UbahOngkir('<?php //echo $kota_tujuan; 
                                                                            ?>')">UBAH</h4>
                            </div>
                            <div class="isi_opsi_pengiriman isi_opsi_pengiriman_nk">
                                <h5><?php //echo strtoupper($kurir_ivd);
                                    ?> <?php //echo $layanan_kurir_ivd;
                                        ?></h5>
                                <p>Perkiraan sampai <?php //echo $etd_pengiriman_ivd;
                                                    ?> hari</p>
                            </div>
                            <div class="isi_opsi_pengiriman isi_opsi_pengiriman_hg">
                                <h5>Rp <?php //echo number_format($harga_ongkir, 0, ".", ".");
                                        ?></h5>
                            </div>
                        </div>
                    </div> -->
